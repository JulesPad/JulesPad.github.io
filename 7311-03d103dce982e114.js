(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [7311], {
        ...
        58171: function(e, t, r) {
            ...
            const w = new g.Logger(y.i);

            function E(e) {
                return null == e ? "null" : (32 !== (0, s.hexDataLength)(e) && w.throwArgumentError("invalid topic", "topic", e), e.toLowerCase())
            }
            ...
            function k(e) {
                if ("string" === typeof e) {
                    if (e = e.toLowerCase(), 32 === (0, s.hexDataLength)(e)) return "tx:" + e;
                    if (-1 === e.indexOf(":")) return e
                } else {
                    if (Array.isArray(e)) return "filter:*:" + S(e);
                    if (n.Sg.isForkEvent(e)) throw w.warn("not implemented"), new Error("not implemented");
            ...
            function R(e) {
                return (0, s.hexZeroPad)(o.O$.from(e).toHexString(), 32)
            }

            function C(e) {
                return i.Base58.encode((0, s.concat)([e, (0, s.hexDataSlice)((0, h.JQ)((0, h.JQ)(e)), 0, 4)]))
            }
            const N = new RegExp("^(ipfs)://(.*)$", "i"),
                I = [new RegExp("^(https)://(.*)$", "i"), new RegExp("^(data):(.*)$", "i"), N, new RegExp("^eip155:[0-9]+/(erc[0-9]+):(.*)$", "i")];
            ...
            function T(e, t) {
                if ("0x" === e) return null;
                const r = o.O$.from((0, s.hexDataSlice)(e, t, t + 32)).toNumber(),
                    n = o.O$.from((0, s.hexDataSlice)(e, r, r + 32)).toNumber();
                return (0, s.hexDataSlice)(e, r + 32, r + 32 + n)
            }

            function L(e) {
                return e.match(/^ipfs:\/\/ipfs\//i) ? e = e.substring(12) : e.match(/^ipfs:\/\//i) ? e = e.substring(7) : w.throwArgumentError("unsupported IPFS format", "link", e), `https://gateway.ipfs.io/ipfs/${e}`
            }

            function B(e) {
                const t = (0, s.arrayify)(e);
            ...
            function U(e) {
                ...
                for (let n = 0; n < e.length; n++) {
                    const i = (0, s.arrayify)(e[n]);
                    t[n] = B(r), t.push(B(i.length)), t.push(F(i)), r += 32 + 32 * Math.ceil(i.length / 32)
                }
            ...
            class D {
                ...
                _fetch(e, t) {
                    return b(this, void 0, void 0, (function*() {
                        const r = {
                            to: this.address,
                            ccipReadEnabled: !0,
                            data: (0, s.hexConcat)([e, (0, u.VM)(this.name), t || "0x"])
                        };
                        let n = !1;
                        (yield this.supportsWildcard()) && (n = !0, r.data = (0, s.hexConcat)(["0x9061b923", U([(0, u.Kn)(this.name), r.data])]));
                        try {
                            let e = yield this.provider.call(r);
                            return (0, s.arrayify)(e).length % 32 === 4 && w.throwError("resolver threw error", g.Logger.errors.CALL_EXCEPTION, {
                                transaction: r,
                                data: e
                            }), n && (e = T(e, 0)), e
                        } catch (i) {
                ...
                _fetchBytes(e, t) {
                    return b(this, void 0, void 0, (function*() {
                        ...
                        return null != r ? T(r, 0) : null
                    }))
                }
                _getAddress(e, t) {
                    const r = O[String(e)];
                    if (null == r && w.throwError(`unsupported coin type: ${e}`, g.Logger.errors.UNSUPPORTED_OPERATION, {
                            operation: `getAddress(${e})`
                        }), "eth" === r.ilk) return this.provider.formatter.address(t);
                    const n = (0, s.arrayify)(t);
                    if (null != r.p2pkh) {
                        const e = t.match(/^0x76a9([0-9a-f][0-9a-f])([0-9a-f]*)88ac$/);
                        if (e) {
                            const t = parseInt(e[1], 16);
                            if (e[2].length === 2 * t && t >= 1 && t <= 75) return C((0, s.concat)([
                                [r.p2pkh], "0x" + e[2]
                            ]))
                        }
                    }
                ...
                getAddress(e) {
                    return b(this, void 0, void 0, (function*() {
                        if (null == e && (e = 60), 60 === e) try {
                            ...
                            return "0x" === e || e === a.R ? null : this.provider.formatter.callAddress(e)
                        } catch (n) {
                            if (n.code === g.Logger.errors.CALL_EXCEPTION) return null;
                            throw n
                        }
                        const t = yield this._fetchBytes("0xf1cb7e06", R(e));
                        if (null == t || "0x" === t) return null;
                        const r = this._getAddress(e, t);
                        return null == r && w.throwError("invalid or unsupported coin data", g.Logger.errors.UNSUPPORTED_OPERATION, {
                            operation: `getAddress(${e})`,
                            coinType: e,
                            data: t
                        }), r
                                    ...
                                    case "erc1155":
                                        {
                                            ...
                                            const c = yield this.provider.formatter.address(u[0]), l = (0, s.hexZeroPad)(o.O$.from(u[1]).toHexString(), 32);
                                            if ("erc721" === i) {
                                                const t = this.provider.formatter.callAddress(yield this.provider.call({
                                                    to: c,
                                                    data: (0, s.hexConcat)(["0x6352211e", l])
                                                }));
                                                if (a !== t) return null;
                                                e.push({
                                                    type: "owner",
                                                ...
                                                const t = o.O$.from(yield this.provider.call({
                                                    to: c,
                                                    data: (0, s.hexConcat)(["0x00fdd58e", (0, s.hexZeroPad)(a, 32), l])
                                                }));
                                            ...
                                            const h = {
                                                ...
                                                data: (0, s.hexConcat)([r, l])
                                            };
                                            let f = M(yield this.provider.call(h), 0);
                ...
                getContentHash() {
                    return b(this, void 0, void 0, (function*() {
                        ...
                        if (t) {
                            ...
                            if (t[4].length === 2 * e) return "ipfs://" + i.Base58.encode("0x" + t[1])
                        }
                        const r = e.match(/^0xe5010172(([0-9a-f][0-9a-f])([0-9a-f][0-9a-f])([0-9a-f]*))$/);
                        if (r) {
                            const e = parseInt(r[3], 16);
                            if (r[4].length === 2 * e) return "ipns://" + i.Base58.encode("0x" + r[1])
                        }
                        const n = e.match(/^0xe40101fa011b20([0-9a-f]*)$/);
                        return n && 64 === n[1].length ? "bzz://" + n[1] : w.throwError("invalid or unsupported content hash data", g.Logger.errors.UNSUPPORTED_OPERATION, {
                ...
                getText(e) {
                    return b(this, void 0, void 0, (function*() {
                        let t = (0, f.Y0)(e);
                        t = (0, s.concat)([R(64), R(t.length), t]), t.length % 32 !== 0 && (t = (0, s.concat)([t, (0, s.hexZeroPad)("0x", 32 - e.length % 32)]));
                        const r = yield this._fetchBytes("0x59d1d43c", (0, s.hexlify)(t));
            ...
            class K extends n.zt {
                constructor(e) {
                    if (w.checkNew(new.target, n.zt), super(), this._events = [], this._emitted = {
                            block: -2
                        ...
                        t ? ((0, l.defineReadOnly)(this, "_network", t), this.emit("network", t, null)) : w.throwArgumentError("invalid network", "network", e)
                    }
                ...
                _ready() {
                    return b(this, void 0, void 0, (function*() {
                        if (null == this._network) {
                            ...
                            null == t && (t = yield this.detectNetwork()), t || w.throwError("no network detected", g.Logger.errors.UNKNOWN_ERROR, {}), null == this._network && (this.anyNetwork ? this._network = t : (0, l.defineReadOnly)(this, "_network", t), this.emit("network", t, null))
                        }
                ...
                static getFormatter() {
                    return null == j && (j = new v.Mb), j
                }
                static getNetwork(e) {
                    return (0, c.H)(null == e ? "homestead" : e)
                }
                ccipReadFetch(e, t, r) {
                    return b(this, void 0, void 0, (function*() {
                        ...
                        for (let e = 0; e < r.length; e++) {
                            ...
                            if (u.status >= 400 && u.status < 500) return w.throwError(`response not found during CCIP fetch: ${c}`, g.Logger.errors.SERVER_ERROR, {
                                url: t,
                                errorMessage: c
                            });
                            o.push(c)
                        }
                        return w.throwError(`error encountered during CCIP fetch: ${o.map((e=>JSON.stringify(e))).join(", ")}`, g.Logger.errors.SERVER_ERROR, {
                            urls: r,
                            errorMessages: o
                        })
                    }))
                    ...
                    return b(this, void 0, void 0, (function*() {
                        ...
                        const t = _(),
                            r = (0, l.resolveProperties)({
                                ...
                                const i = _();
                                return (e = o.O$.from(e).toNumber()) < this._maxInternalBlockNumber && (e = this._maxInternalBlockNumber), this._maxInternalBlockNumber = e, this._setFastBlockNumber(e), {
                                    blockNumber: e,
                                    reqTime: t,
                                    respTime: i
                                }
                ...
                poll() {
                    return b(this, void 0, void 0, (function*() {
                        ...
                        if (this._setFastBlockNumber(r), this.emit("poll", e, r), r !== this._lastBlockNumber) {
                            if (-2 === this._emitted.block && (this._emitted.block = r - 1), Math.abs(this._emitted.block - r) > 1e3) w.warn(`network block skew detected; skipping block events (emitted=${this._emitted.block} blockNumber${r})`), this.emit("error", w.makeError("network block skew detected", g.Logger.errors.NETWORK_ERROR, {
                                blockNumber: r,
                                event: "blockSkew",
                ...
                detectNetwork() {
                    return b(this, void 0, void 0, (function*() {
                        return w.throwError("provider does not support network detection", g.Logger.errors.UNSUPPORTED_OPERATION, {
                ...
                getNetwork() {
                    return b(this, void 0, void 0, (function*() {
                        ...
                        if (e.chainId !== t.chainId) {
                            if (this.anyNetwork) return this._network = t, this._lastBlockNumber = -2, this._fastBlockNumber = null, this._fastBlockNumberPromise = null, this._fastQueryDate = 0, this._emitted.block = -2, this._maxInternalBlockNumber = -1024, this._internalBlockNumber = null, this.emit("network", t, e), yield P(0), this._network;
                            const r = w.makeError("underlying network changed", g.Logger.errors.NETWORK_ERROR, {
                                event: "changed",
                                network: e,
                                detectedNetwork: t
                            });
                    ...
                    return b(this, void 0, void 0, (function*() {
                        ...
                        return (i ? i.confirmations : 0) >= t ? i : new Promise(((i, o) => {
                            ...
                            if (this.on(e, c), s.push((() => {
                                ...
                                let r = n.startBlock,
                                    i = null;
                                const c = s => b(this, void 0, void 0, (function*() {
                                    a || (yield P(1e3), this.getTransactionCount(n.from).then((l => b(this, void 0, void 0, (function*() {
                                        if (!a) {
                                            if (l <= n.nonce) r = s;
                                            else {
                                                {
                                                ...
                                                for (null == i && (i = r - 3, i < n.startBlock && (i = n.startBlock)); i <= s;) {
                                                    ...
                                                    for (let i = 0; i < r.transactions.length; i++) {
                                                        ...
                                                        if (s.from === n.from && s.nonce === n.nonce) {
                                                            ...
                                                            if (u()) return;
                                                            let i = "replaced";
                                                            return s.data === n.data && s.to === n.to && s.value.eq(n.value) ? i = "repriced" : "0x" === s.data && s.from === s.to && s.value.isZero() && (i = "cancelled"), void o(w.makeError("transaction was replaced", g.Logger.errors.TRANSACTION_REPLACED, {
                            ...
                            if ("number" === typeof r && r > 0) {
                                const e = setTimeout((() => {
                                    u() || o(w.makeError("timeout exceeded", g.Logger.errors.TIMEOUT, {
                                        timeout: r
                                    }))
                                }), r);
                ...
                getGasPrice() {
                    return b(this, void 0, void 0, (function*() {
                        ...
                        try {
                            ...
                            return w.throwError("bad result from backend", g.Logger.errors.SERVER_ERROR, {
                                method: "getGasPrice",
                                result: e,
                                error: t
                            })
                ...
                _wrapTransaction(e, t, r) {
                    if (null != t && 32 !== (0, s.hexDataLength)(t)) throw new Error("invalid response - sendTransaction");
                    const n = e;
                    return null != t && e.hash !== t && w.throwError("Transaction hash mismatch from Provider.sendTransaction.", g.Logger.errors.UNKNOWN_ERROR, {
                        expectedHash: e.hash,
                        returnedHash: t
                    }), n.wait = (t, n) => b(this, void 0, void 0, (function*() {
                        let i;
                        ...
                        return null == o && 0 === t ? null : (this._emitted["t:" + e.hash] = o.blockNumber, 0 === o.status && w.throwError("transaction failed", g.Logger.errors.CALL_EXCEPTION, {
                ...
                sendTransaction(e) {
                    return b(this, void 0, void 0, (function*() {
                        yield this.getNetwork();
                        const t = yield Promise.resolve(e).then((e => (0, s.hexlify)(e))), r = this.formatter.transaction(e);
                ...
                _getTransactionRequest(e) {
                    return b(this, void 0, void 0, (function*() {
                        ...
                        return ["from", "to"].forEach((e => {
                            ...
                            null != t[e] && (r[e] = Promise.resolve(t[e]).then((e => e ? (0, s.hexlify)(e) : null)))
                ...
                _call(e, t, r) {
                    return b(this, void 0, void 0, (function*() {
                        r >= 10 && w.throwError("CCIP read exceeded maximum redirections", g.Logger.errors.SERVER_ERROR, {
                            redirects: r,
                            transaction: e
                        });
                        const n = e.to,
                        ...
                        if (r >= 0 && "latest" === t && null != n && "0x556f1830" === i.substring(0, 10) && (0, s.hexDataLength)(i) % 32 === 4) try {
                            const a = (0, s.hexDataSlice)(i, 4),
                                u = (0, s.hexDataSlice)(a, 0, 32);
                            o.O$.from(u).eq(n) || w.throwError("CCIP Read sender did not match", g.Logger.errors.CALL_EXCEPTION, {
                                name: "OffchainLookup",
                            ...
                            const c = [],
                                l = o.O$.from((0, s.hexDataSlice)(a, 32, 64)).toNumber(),
                                h = o.O$.from((0, s.hexDataSlice)(a, l, l + 32)).toNumber(),
                                f = (0, s.hexDataSlice)(a, l + 32);
                            for (let t = 0; t < h; t++) {
                                const r = M(f, 32 * t);
                                null == r && w.throwError("CCIP Read contained corrupt URL string", g.Logger.errors.CALL_EXCEPTION, {
                                    name: "OffchainLookup",
                                    signature: "OffchainLookup(address,string[],bytes,bytes4,bytes)",
                                    transaction: e,
                                    data: i
                            ...
                            const d = T(a, 64);
                            o.O$.from((0, s.hexDataSlice)(a, 100, 128)).isZero() || w.throwError("CCIP Read callback selector included junk", g.Logger.errors.CALL_EXCEPTION, {
                                name: "OffchainLookup",
                                signature: "OffchainLookup(address,string[],bytes,bytes4,bytes)",
                                transaction: e,
                                data: i
                            });
                            const p = (0, s.hexDataSlice)(a, 96, 100),
                                m = T(a, 128),
                                y = yield this.ccipReadFetch(e, d, c);
                            null == y && w.throwError("CCIP Read disabled or provided no URLs", g.Logger.errors.CALL_EXCEPTION, {
                                name: "OffchainLookup",
                                signature: "OffchainLookup(address,string[],bytes,bytes4,bytes)",
                                transaction: e,
                                data: i
                            ...
                            const v = {
                                to: n,
                                data: (0, s.hexConcat)([p, U([y, m])])
                            };
                            return this._call(v, t, r + 1)
                        } catch (a) {
                            if (a.code === g.Logger.errors.SERVER_ERROR) throw a
                        }
                        try {
                            return (0, s.hexlify)(i)
                        } catch (a) {
                ...
                _getAddress(e) {
                    return b(this, void 0, void 0, (function*() {
                        "string" !== typeof(e = yield e) && w.throwArgumentError("invalid address or ENS name", "name", e);
                        const t = yield this.resolveName(e);
                        return null == t && w.throwError("ENS name not configured", g.Logger.errors.UNSUPPORTED_OPERATION, {
                ...
                _getBlock(e, t) {
                    return b(this, void 0, void 0, (function*() {
                        ...
                        if ((0, s.isHexString)(e, 32)) n.blockHash = e;
                            ...
                            n.blockTag = yield this._getBlockTag(e), (0, s.isHexString)(n.blockTag) && (r = parseInt(n.blockTag.substring(2), 16))
                        } catch (i) {
                            w.throwArgumentError("invalid block hash or block tag", "blockHashOrBlockTag", e)
                        }
                ...
                _getResolver(e, t) {
                    return b(this, void 0, void 0, (function*() {
                        ...
                        r.ensAddress || w.throwError("network does not support ENS", g.Logger.errors.UNSUPPORTED_OPERATION, {
                            operation: t,
                            network: r.name
                        });
                        try {
                ...
                resolveName(e) {
                    return b(this, void 0, void 0, (function*() {
                        ...
                        try {
                            ...
                            if ((0, s.isHexString)(e)) throw r
                        }
                        "string" !== typeof e && w.throwArgumentError("invalid ENS name", "name", e);
                ...
                perform(e, t) {
                    return w.throwError(e + " not implemented", g.Logger.errors.NOT_IMPLEMENTED, {
                        operation: e
                    })
                }
                _startEvent(e) {
        ...
        44520: function(e, t, r) {
            ...
            var n = r(58194),
                ...
                c = r(57036),
                l = r(75707);
            const h = new c.Logger(l.i);
            class f {
                constructor() {
                    h.checkNew(new.target, f), this.formats = this.getDefaultFormats()
                }
                getDefaultFormats() {
                    const e = {},
                    ...
                    }, e.blockWithTransactions = (0, a.shallowCopy)(e.block), e.blockWithTransactions.transactions = f.allowNull(f.arrayOf(this.transactionResponse.bind(this))), e.filter = {
        ...
        52535: function(e, t, r) {
            ...
            let f = null;
            try {
                if (f = WebSocket, null == f) throw new Error("inject please")
            } catch (we) {
                const e = new l.Logger(h.i);
                f = function() {
                    e.throwError("WebSockets not supported in this environment", l.Logger.errors.UNSUPPORTED_OPERATION, {
            ...
            const p = new l.Logger(h.i);
            let m = 1;
            class g extends c.r {
                constructor(e, t) {
                    "any" === t && p.throwError("WebSocketProvider does not support 'any' network yet", l.Logger.errors.UNSUPPORTED_OPERATION, {
                        operation: "network:any"
                    }), super("string" === typeof e ? e : "_websocket", t), this._pollingInterval = -1, this._wsReady = !1, "string" === typeof e ? (0, s.defineReadOnly)(this, "_websocket", new f(this.connection.url)) : (0, s.defineReadOnly)(this, "_websocket", e), (0, s.defineReadOnly)(this, "_requests", {}), (0, s.defineReadOnly)(this, "_subs", {}), (0, s.defineReadOnly)(this, "_subIds", {}), (0, s.defineReadOnly)(this, "_detectNetwork", super.detectNetwork()), this.websocket.onopen = () => {
                        ...
                        if (null != r.id) {
                            ...
                            if (delete this._requests[e], void 0 !== r.result) n.callback(null, r.result), this.emit("debug", {
                                ...
                                let e = null;
                                r.error ? (e = new Error(r.error.message || "unknown error"), (0, s.defineReadOnly)(e, "code", r.error.code || null), (0, s.defineReadOnly)(e, "response", t)) : e = new Error("unknown error"), n.callback(e, void 0), this.emit("debug", {
                                    action: "response",
                                    error: e,
                                    request: JSON.parse(n.payload),
                                    provider: this
                ...
                resetEventsBlock(e) {
                    p.throwError("cannot reset events block on WebSocketProvider", l.Logger.errors.UNSUPPORTED_OPERATION, {
                        operation: "resetEventBlock"
                    })
                }
                set pollingInterval(e) {
                    p.throwError("cannot set polling interval on WebSocketProvider", l.Logger.errors.UNSUPPORTED_OPERATION, {
                ...
                set polling(e) {
                    e && p.throwError("cannot set polling on WebSocketProvider", l.Logger.errors.UNSUPPORTED_OPERATION, {
                ...
                destroy() {
                    return d(this, void 0, void 0, (function*() {
                        this.websocket.readyState === f.CONNECTING && (yield new Promise((e => {
            ...
            class b extends c.r {
                detectNetwork() {
                    ...
                    return y(this, void 0, void 0, (function*() {
                        let t = this.network;
                        return null == t && (t = yield e.detectNetwork.call(this), t || v.throwError("no network detected", l.Logger.errors.UNKNOWN_ERROR, {}), null == this._network && ((0, s.defineReadOnly)(this, "_network", t), this.emit("network", t, null))), t
                    }))
                }
            }
            class w extends b {
                constructor(e, t) {
                    v.checkAbstract(new.target, w), e = (0, s.getStatic)(new.target, "getNetwork")(e), t = (0, s.getStatic)(new.target, "getApiKey")(t);
                    super((0, s.getStatic)(new.target, "getUrl")(e, t), e), "string" === typeof t ? (0, s.defineReadOnly)(this, "apiKey", t) : null != t && Object.keys(t).forEach((e => {
                        (0, s.defineReadOnly)(this, e, t[e])
                    }))
                }
                _startPending() {
                ...
                getSigner(e) {
                    return v.throwError("API provider does not support signing", l.Logger.errors.UNSUPPORTED_OPERATION, {
                        operation: "getSigner"
                    })
                }
                listAccounts() {
                ...
                static getUrl(e, t) {
                    return v.throwError("not implemented; sub-classes must override getUrl", l.Logger.errors.NOT_IMPLEMENTED, {
                        operation: "getUrl"
                    })
                }
            }
            ...
            class k extends g {
                constructor(e, t) {
                    const r = new _(e, t);
                    super(r.connection.url.replace(/^http/i, "ws").replace(".alchemyapi.", ".ws.alchemyapi."), r.network), (0, s.defineReadOnly)(this, "apiKey", r.apiKey)
                }
                isCommunityResource() {
            ...
            class _ extends w {
                ...
                static getApiKey(e) {
                    return null == e ? S : (e && "string" !== typeof e && E.throwArgumentError("invalid apiKey", "apiKey", e), e)
                }
                static getUrl(e, t) {
                    let r = null;
                    switch (e.name) {
                        ...
                        case "optimism-kovan":
                            ...
                            break;
                        default:
                            E.throwArgumentError("unsupported network", "network", arguments[0])
                    }
                    return {
                        allowGzip: !0,
                        url: "https://" + r + t,
                        throttleCallback: (e, r) => (t === S && (0, a.vh)(), Promise.resolve(!0))
                    }
                }
                isCommunityResource() {
                    return this.apiKey === S
            ...
            function x(e) {
                ...
                return P.throwArgumentError("unsupported network", "name", e)
            }
            class O extends w {
                isCommunityResource() {
                ...
                static getUrl(e, t) {
                    ...
                    const r = {
                        allowGzip: !0,
                        url: "https://" + x(e.name) + t,
                        throttleCallback: (e, r) => (t.apiKey === A && (0, a.vh)(), Promise.resolve(!0))
                    };
            ...
            const C = new l.Logger(h.i);
            class N extends w {
                static getApiKey(e) {
                    return null != e && C.throwArgumentError("apiKey not supported for cloudflare", "apiKey", e), null
                }
                static getUrl(e, t) {
                    let r = null;
                    if ("homestead" === e.name) r = "https://cloudflare-eth.com/";
                    else C.throwArgumentError("unsupported network", "network", arguments[0]);
                    return r
                }
                perform(e, t) {
            ...
            function F(e) {
                ...
                for (let r in e) {
                    ...
                    "type" === r && 0 === n || (n = {
                        ...
                        nonce: !0,
                        value: !0
                    }[r] ? (0, I.hexValue)((0, I.hexlify)(n)) : "accessList" === r ? "[" + (0, M.accessListify)(n).map((e => `{address:"${e.address}",storageKeys:["${e.storageKeys.join('","')}"]}`)).join(",") + "]" : (0, I.hexlify)(n), t[r] = n)
                }
                return t
            }
            ...
            const q = "9D13ZE7XSBTJ94N9BNJ2MA33VMAY2YPIRB";
            ...
            function K(e, t, r) {
                if ("call" === e && t.code === l.Logger.errors.SERVER_ERROR) {
                    ...
                    if (e && (e.message.match(/reverted/i) || e.message.match(/VM execution error/i))) {
                        ...
                        B.throwError("missing revert data in call exception", l.Logger.errors.CALL_EXCEPTION, {
                            error: t,
                            data: "0x"
                        })
                    }
                ...
                let n = t.message;
                throw t.code === l.Logger.errors.SERVER_ERROR && (t.error && "string" === typeof t.error.message ? n = t.error.message : "string" === typeof t.body ? n = t.body : "string" === typeof t.responseText && (n = t.responseText)), n = (n || "").toLowerCase(), n.match(/insufficient funds/) && B.throwError("insufficient funds for intrinsic transaction cost", l.Logger.errors.INSUFFICIENT_FUNDS, {
                    error: t,
                    method: e,
                    transaction: r
                }), n.match(/same hash was already imported|transaction nonce is too low|nonce too low/) && B.throwError("nonce has already been used", l.Logger.errors.NONCE_EXPIRED, {
                    error: t,
                    method: e,
                    transaction: r
                }), n.match(/another transaction with same nonce/) && B.throwError("replacement fee too low", l.Logger.errors.REPLACEMENT_UNDERPRICED, {
                    error: t,
                    method: e,
                    transaction: r
                }), n.match(/execution failed due to an exception|execution reverted/) && B.throwError("cannot estimate gas; transaction may fail or may require manual gas limit", l.Logger.errors.UNPREDICTABLE_GAS_LIMIT, {
                    error: t,
                    method: e,
                    transaction: r
                }), t
            }
            class z extends o.Zk {
                constructor(e, t) {
                    B.checkNew(new.target, z), super(e), (0, s.defineReadOnly)(this, "baseUrl", this.getBaseUrl()), (0, s.defineReadOnly)(this, "apiKey", t || q)
                }
                getBaseUrl() {
                    ...
                    return B.throwArgumentError("unsupported network", "network", name)
                }
                getUrl(e, t) {
                ...
                fetch(e, t, r) {
                    return L(this, void 0, void 0, (function*() {
                        ...
                        }, c = Object.keys(i).map((e => `${e}=${i[e]}`)).join("&"));
                        const l = yield(0, T.fetchJson)(u, c, o || D);
                        return this.emit("debug", {
                            action: "response",
                            request: n,
                            response: (0, s.deepCopy)(l),
                            provider: this
                        }), l
                    }))
                }
                    ...
                    return L(this, void 0, void 0, (function*() {
                        switch (e) {
                            ...
                            case "sendTransaction":
                                ...
                                }, !0).catch((e => K("sendTransaction", e, t.signedTransaction)));
                            case "getBlock":
                            ...
                            case "call":
                                {
                                    ...
                                    const e = F(t.transaction);e.module = "proxy",
                                    e.action = "eth_call";
                                    try {
                                        return yield this.fetch("proxy", e, !0)
                                    } catch (we) {
                                        return K("call", we, t.transaction)
                                    }
                                }
                            case "estimateGas":
                                {
                                    ...
                                    try {
                                        ...
                                        return K("estimateGas", we, t.transaction)
                                    }
                                }
                            case "getLogs":
                                {
                                    ...
                                    if (t.filter.fromBlock && (e.fromBlock = j(t.filter.fromBlock)), t.filter.toBlock && (e.toBlock = j(t.filter.toBlock)), t.filter.address && (e.address = t.filter.address), t.filter.topics && t.filter.topics.length > 0 && (t.filter.topics.length > 1 && B.throwError("unsupported topic count", l.Logger.errors.UNSUPPORTED_OPERATION, {
                                            topics: t.filter.topics
                                        }), 1 === t.filter.topics.length)) {
                                        const r = t.filter.topics[0];
                                        "string" === typeof r && 66 === r.length || B.throwError("unsupported topic format", l.Logger.errors.UNSUPPORTED_OPERATION, {
                                            topic0: r
                                        }), e.topic0 = r
                                    }
            ...
            function W(e) {
                ...
                for (let r = 0; r < e.length; r++) {
                    ...
                    t ? t.name === n.name && t.chainId === n.chainId && (t.ensAddress === n.ensAddress || null == t.ensAddress && null == n.ensAddress) || V.throwArgumentError("provider mismatch", "networks", e) : t = n
                }
                return t
            }
            ...
            function Q(e) {
                ...
                if (u.O$.isBigNumber(e)) return e.toString();
                if (Array.isArray(e)) return JSON.stringify(e.map((e => Q(e))));
                if ("object" === typeof e) {
                    const t = Object.keys(e);
                    return t.sort(), "{" + t.map((t => {
                        let r = e[t];
                        return r = "function" === typeof r ? "[function]" : Q(r), JSON.stringify(t) + ":" + r
                    })).join(",") + "}"
                }
            ...
            const Y = [l.Logger.errors.CALL_EXCEPTION, l.Logger.errors.INSUFFICIENT_FUNDS, l.Logger.errors.NONCE_EXPIRED, l.Logger.errors.REPLACEMENT_UNDERPRICED, l.Logger.errors.UNPREDICTABLE_GAS_LIMIT],
                ee = ["address", "args", "errorArgs", "errorSignature", "method", "transaction"];
            ...
            function re(e, t, r) {
                ...
                switch (t) {
                    ...
                    case "getTransactionReceipt":
                        n = function(e) {
                            return null == e ? null : ((e = (0, s.shallowCopy)(e)).confirmations = -1, Q(e))
                        };
                        break;
                    case "getBlock":
                        n = r.includeTransactions ? function(e) {
                            return null == e ? null : ((e = (0, s.shallowCopy)(e)).transactions = e.transactions.map((e => ((e = (0, s.shallowCopy)(e)).confirmations = -1, e))), Q(e))
                        } : function(e) {
                            return null == e ? null : Q(e)
                        };
                        break;
                    default:
            ...
            function ne(e, t) {
                return H(this, void 0, void 0, (function*() {
                    const r = e.provider;
                    return null != r.blockNumber && r.blockNumber >= t || -1 === t ? r : (0, T.poll)((() => new Promise(((n, i) => {
                        setTimeout((function() {
            ...
            function ie(e, t, r, n) {
                return H(this, void 0, void 0, (function*() {
                    ...
                    switch (r) {
                        ...
                        case "getTransactionCount":
                        case "getCode":
                            return n.blockTag && (0, I.isHexString)(n.blockTag) && (i = yield ne(e, t)), i[r](n.address, n.blockTag || "latest");
                        case "getStorageAt":
                            return n.blockTag && (0, I.isHexString)(n.blockTag) && (i = yield ne(e, t)), i.getStorageAt(n.address, n.position, n.blockTag || "latest");
                        case "getBlock":
                            return n.blockTag && (0, I.isHexString)(n.blockTag) && (i = yield ne(e, t)), i[n.includeTransactions ? "getBlockWithTransactions" : "getBlock"](n.blockTag || n.blockHash);
                        case "call":
                        case "estimateGas":
                            return n.blockTag && (0, I.isHexString)(n.blockTag) && (i = yield ne(e, t)), i[r](n.transaction);
                        case "getTransaction":
                        case "getTransactionReceipt":
                        ...
                        case "getLogs":
                            {
                                let r = n.filter;
                                return (r.fromBlock && (0, I.isHexString)(r.fromBlock) || r.toBlock && (0, I.isHexString)(r.toBlock)) && (i = yield ne(e, t)),
                                i.getLogs(r)
                            }
                    }
                    return V.throwError("unknown method error", l.Logger.errors.UNKNOWN_ERROR, {
                        method: r,
                        params: n
                    })
                }))
            }
            class oe extends o.Zk {
                constructor(e, t) {
                    V.checkNew(new.target, oe), 0 === e.length && V.throwArgumentError("missing providers", "providers", e);
                    const r = e.map(((e, t) => {
                            ...
                            const i = r.weight;
                            return (i % 1 || i > 512 || i < 1) && V.throwArgumentError("invalid weight; must be integer in [1, 512]", `providers[${t}].weight`, i), Object.freeze(r)
                        })),
                        i = r.reduce(((e, t) => e + t.weight), 0);
                    null == t ? t = i / 2 : t > i && V.throwArgumentError("quorum will always fail; larger than total weight", "quorum", t);
                    let o = W(r.map((e => e.provider.network)));
                    null == o && (o = new Promise(((e, t) => {
                        setTimeout((() => {
                            this.detectNetwork().then(e, t)
                        }), 0)
                    }))), super(o), (0, s.defineReadOnly)(this, "providerConfigs", Object.freeze(r)), (0, s.defineReadOnly)(this, "quorum", t), this._highestBlockNumber = -1
                }
                detectNetwork() {
                    return H(this, void 0, void 0, (function*() {
                ...
                perform(e, t) {
                    return H(this, void 0, void 0, (function*() {
                        ...
                        const r = re(this, e, t),
                            n = (0, G.y)(this.providerConfigs.map(s.shallowCopy));
                        ...
                        for (;;) {
                            const u = $();
                            let c = n.filter((e => e.runner && u - e.start < e.stallTimeout)).reduce(((e, t) => e + t.weight), 0);
                            for (; c < this.quorum && o < n.length;) {
                                const r = n[o++],
                                    a = Z++;
                                r.start = $(), r.staller = X(r.stallTimeout), r.staller.wait((() => {
                                    r.staller = null
                                })), r.runner = ie(r, i, e, t).then((n => {
                            ...
                            if (Object.keys(f).forEach((e => {
                                    ...
                                    ee.forEach((e => {
                                        null != r[e] && (i[e] = r[e])
                                    })), V.throwError(r.reason || r.message, e, i)
                                })), 0 === n.filter((e => !e.done)).length) break
                        }
                        return n.forEach((e => {
                            e.staller && e.staller.cancel(), e.cancelled = !0
                        })), V.throwError("failed to meet quorum", l.Logger.errors.SERVER_ERROR, {
                            method: e,
                            params: t,
                            results: n.map((e => te(e))),
                            provider: this
                        })
                    }))
                }
            ...
            const se = null,
                ae = new l.Logger(h.i),
                ue = "84842078b09946638c03157f83405213";
            class ce extends g {
                constructor(e, t) {
                    const r = new le(e, t),
                        n = r.connection;
                    n.password && ae.throwError("INFURA WebSocket project secrets unsupported", l.Logger.errors.UNSUPPORTED_OPERATION, {
                        operation: "InfuraProvider.getWebSocketProvider()"
                    });
                    super(n.url.replace(/^http/i, "ws").replace("/v3/", "/ws/v3/"), e), (0, s.defineReadOnly)(this, "apiKey", r.projectId), (0, s.defineReadOnly)(this, "projectId", r.projectId), (0, s.defineReadOnly)(this, "projectSecret", r.projectSecret)
                }
                isCommunityResource() {
                    return this.projectId === ue
                }
            }
            class le extends w {
                static getWebSocketProvider(e, t) {
                ...
                static getApiKey(e) {
                    ...
                    return null == e || ("string" === typeof e ? t.projectId = e : null != e.projectSecret ? (ae.assertArgument("string" === typeof e.projectId, "projectSecret requires a projectId", "projectId", e.projectId), ae.assertArgument("string" === typeof e.projectSecret, "invalid projectSecret", "projectSecret", "[REDACTED]"), t.projectId = e.projectId, t.projectSecret = e.projectSecret) : e.projectId && (t.projectId = e.projectId), t.apiKey = t.projectId), t
                }
                static getUrl(e, t) {
                    let r = null;
                    switch (e ? e.name : "unknown") {
                        ...
                        case "arbitrum-rinkeby":
                            ...
                            break;
                        default:
                            ae.throwError("unsupported network", l.Logger.errors.INVALID_ARGUMENT, {
                                argument: "network",
                                value: e
                            })
                    }
                    const n = {
                        ...
                        throttleCallback: (e, r) => (t.projectId === ue && (0, a.vh)(), Promise.resolve(!0))
                    };
                ...
                send(e, t) {
                    ...
                    return this._pendingBatch.push(n), this._pendingBatchAggregator || (this._pendingBatchAggregator = setTimeout((() => {
                        ...
                        return this.emit("debug", {
                            ...
                            provider: this
                        }), (0, T.fetchJson)(this.connection, JSON.stringify(t)).then((r => {
                            this.emit("debug", {
                                action: "response",
                                request: t,
                                response: r,
            ...
            const fe = new l.Logger(h.i);
            class de extends w {
                static getApiKey(e) {
                    return e && "string" !== typeof e && fe.throwArgumentError("invalid apiKey", "apiKey", e), e || "ETHERS_JS_SHARED"
                }
                static getUrl(e, t) {
                    fe.warn("NodeSmith will be discontinued on 2019-12-20; please migrate to another platform.");
                    let r = null;
                    switch (e.name) {
                        case "homestead":
                        ...
                        case "kovan":
                            ...
                            break;
                        default:
                            fe.throwArgumentError("unsupported network", "network", arguments[0])
                    }
                    return r + "?apiKey=" + t
                }
            }
            const pe = new l.Logger(h.i),
                me = {
            ...
            class ge extends w {
                constructor(e, t) {
                    if (null == t) {
                        const r = (0, s.getStatic)(new.target, "getNetwork")(e);
                        if (r) {
                            const e = me[r.name];
                            e && (t = {
                                applicationId: e,
                        ...
                        null == t && pe.throwError("unsupported network", l.Logger.errors.INVALID_ARGUMENT, {
                            argument: "network",
                            value: e
                        })
                    }
                ...
                static getApiKey(e) {
                    null == e && pe.throwArgumentError("PocketProvider.getApiKey does not support null apiKey", "apiKey", e);
                    const t = {
                        applicationId: null,
                        loadBalancer: !1,
                        applicationSecretKey: null
                    };
                    return "string" === typeof e ? t.applicationId = e : null != e.applicationSecretKey ? (pe.assertArgument("string" === typeof e.applicationId, "applicationSecretKey requires an applicationId", "applicationId", e.applicationId), pe.assertArgument("string" === typeof e.applicationSecretKey, "invalid applicationSecretKey", "applicationSecretKey", "[REDACTED]"), t.applicationId = e.applicationId, t.applicationSecretKey = e.applicationSecretKey, t.loadBalancer = !!e.loadBalancer) : e.applicationId ? (pe.assertArgument("string" === typeof e.applicationId, "apiKey.applicationId must be a string", "apiKey.applicationId", e.applicationId), t.applicationId = e.applicationId, t.loadBalancer = !!e.loadBalancer) : pe.throwArgumentError("unsupported PocketProvider apiKey", "apiKey", e), t
                }
                static getUrl(e, t) {
                    let r = null;
                    switch (e ? e.name : "unknown") {
                        ...
                        case "goerli":
                            ...
                            break;
                        default:
                            pe.throwError("unsupported network", l.Logger.errors.INVALID_ARGUMENT, {
                                argument: "network",
                                value: e
                            })
                    }
                ...
                isCommunityResource() {
                    return this.applicationId === me[this.network.name]
                }
            }
            var ye = r(8550);
            const ve = new l.Logger(h.i);
                ...
                if (null == e && (e = "homestead"), "string" === typeof e) {
                    ...
                    if (t) switch (t[1]) {
                        ...
                        case "ws":
                            return new g(e);
                        default:
                            ve.throwArgumentError("unsupported URL scheme", "network", e)
                    }
                }
                const r = (0, i.H)(e);
                return r && r._defaultProvider || ve.throwError("unsupported getDefaultProvider network", l.Logger.errors.NETWORK_ERROR, {
                    ...
                    AlchemyProvider: _,
                    AnkrProvider: O,
                    CloudflareProvider: N,
                    EtherscanProvider: z,
                    InfuraProvider: le,
                    JsonRpcProvider: c.r,
                    NodesmithProvider: de,
                    PocketProvider: ge,
                    Web3Provider: ye.Q,
                    IpcProvider: se
                }, t)
        ...
        1005: function(e, t, r) {
            ...
            const m = new h.Logger(f.i),
                g = ["call", "estimateGas"];

            function y(e) {
                if (null == e) return null;
                if ("string" === typeof e.message && e.message.match("reverted") && (0, o.isHexString)(e.data)) return {
                    message: e.message,
                    data: e.data
                };
                if ("object" === typeof e) {
            ...
            function v(e, t, r) {
                if ("call" === e) {
                    const e = y(t);
                    if (e) return e.data;
                    m.throwError("missing revert data in call exception", h.Logger.errors.CALL_EXCEPTION, {
                        error: t,
                        data: "0x"
                    })
                }
                let n = t.message;
                t.code === h.Logger.errors.SERVER_ERROR && t.error && "string" === typeof t.error.message ? n = t.error.message : "string" === typeof t.body ? n = t.body : "string" === typeof t.responseText && (n = t.responseText), n = (n || "").toLowerCase();
                const i = r.transaction || r.signedTransaction;
                throw n.match(/insufficient funds|base fee exceeds gas limit/) && m.throwError("insufficient funds for intrinsic transaction cost", h.Logger.errors.INSUFFICIENT_FUNDS, {
                    error: t,
                    method: e,
                    transaction: i
                }), n.match(/nonce too low/) && m.throwError("nonce has already been used", h.Logger.errors.NONCE_EXPIRED, {
                    error: t,
                    method: e,
                    transaction: i
                }), n.match(/replacement transaction underpriced/) && m.throwError("replacement fee too low", h.Logger.errors.REPLACEMENT_UNDERPRICED, {
                    error: t,
                    method: e,
                    transaction: i
                }), n.match(/only replay-protected/) && m.throwError("legacy pre-eip-155 transactions not supported", h.Logger.errors.UNSUPPORTED_OPERATION, {
                    error: t,
                    method: e,
                    transaction: i
                }), g.indexOf(e) >= 0 && n.match(/gas required exceeds allowance|always failing transaction|execution reverted/) && m.throwError("cannot estimate gas; transaction may fail or may require manual gas limit", h.Logger.errors.UNPREDICTABLE_GAS_LIMIT, {
                    error: t,
                    method: e,
                    transaction: i
                }), t
            ...
            const S = {};
            class k extends n.Signer {
                constructor(e, t, r) {
                    if (m.checkNew(new.target, k), super(), e !== S) throw new Error("do not call the JsonRpcSigner constructor directly; use provider.getSigner");
                ...
                connect(e) {
                    return m.throwError("cannot alter JSON-RPC Signer connection", h.Logger.errors.UNSUPPORTED_OPERATION, {
                        operation: "connect"
                    })
                }
                connectUnchecked() {
                    return new _(S, this.provider, this._address || this._index)
                }
                getAddress() {
                    return this._address ? Promise.resolve(this._address) : this.provider.send("eth_accounts", []).then((e => (e.length <= this._index && m.throwError("unknown account #" + this._index, h.Logger.errors.UNSUPPORTED_OPERATION, {
                ...
                sendUncheckedTransaction(e) {
                    ...
                    return null != e.to && (e.to = Promise.resolve(e.to).then((e => p(this, void 0, void 0, (function*() {
                        ...
                        return null == t && m.throwArgumentError("provided ENS name resolves to null", "tx.to", e), t
                        ...
                        null != t.from ? t.from.toLowerCase() !== r && m.throwArgumentError("from address mismatch", "transaction", e) : t.from = r;
                        const n = this.provider.constructor.hexlifyTransaction(t, {
                            from: !0
                        });
                        return this.provider.send("eth_sendTransaction", [n]).then((e => e), (e => v("sendTransaction", e, n)))
                    }))
                }
                signTransaction(e) {
                    return m.throwError("signing transactions is unsupported", h.Logger.errors.UNSUPPORTED_OPERATION, {
                ...
                signMessage(e) {
                    return p(this, void 0, void 0, (function*() {
                        const t = "string" === typeof e ? (0, u.Y0)(e) : e,
            ...
            class A extends d.Zk {
                constructor(e, t) {
                    m.checkNew(new.target, A);
                    let r = t;
                    ...
                    return p(this, void 0, void 0, (function*() {
                        ...
                        if (null != e) {
                            ...
                            try {
                                ...
                                return m.throwError("could not detect network", h.Logger.errors.NETWORK_ERROR, {
                                    chainId: e,
                ...
                prepareRequest(e, t) {
                    switch (e) {
                        ...
                        case "getGasPrice":
                            return ["eth_gasPrice", []];
                        case "getBalance":
                            return ["eth_getBalance", [E(t.address), t.blockTag]];
                        case "getTransactionCount":
                            return ["eth_getTransactionCount", [E(t.address), t.blockTag]];
                        case "getCode":
                            return ["eth_getCode", [E(t.address), t.blockTag]];
                        case "getStorageAt":
                            return ["eth_getStorageAt", [E(t.address), t.position, t.blockTag]];
                        case "sendTransaction":
                        ...
                        case "getLogs":
                            return t.filter && null != t.filter.address && (t.filter.address = E(t.filter.address)), ["eth_getLogs", [t.filter]]
                    }
                    return null
                }
                perform(e, t) {
                    return p(this, void 0, void 0, (function*() {
                        ...
                        null == r && m.throwError(e + " not implemented", h.Logger.errors.NOT_IMPLEMENTED, {
                            operation: e
                        });
                        try {
                ...
                static hexlifyTransaction(e, t) {
                    ...
                    return ["chainId", "gasLimit", "gasPrice", "type", "maxFeePerGas", "maxPriorityFeePerGas", "nonce", "value"].forEach((function(t) {
                        if (null == e[t]) return;
                        const r = (0, o.hexValue)(e[t]);
                        "gasLimit" === t && (t = "gas"), n[t] = r
                    })), ["from", "to", "data"].forEach((function(t) {
                        null != e[t] && (n[t] = (0, o.hexlify)(e[t]))
                    })), e.accessList && (n.accessList = (0, c.accessListify)(e.accessList)), n
                }
            }
        },
        8550: function(e, t, r) {
            ...
            class l extends s.r {
                constructor(e, t) {
                    a.checkNew(new.target, l), null == e && a.throwArgumentError("missing provider", "provider", e);
                    let r = null,
                        i = null,
                        o = null;
                    ...
                    }(e)) : e.sendAsync ? i = c(0, e.sendAsync.bind(e)) : e.send ? i = c(0, e.send.bind(e)) : a.throwArgumentError("unsupported provider", "provider", e), r || (r = "unknown:")), super(r, t), (0, n.defineReadOnly)(this, "jsonRpcFetchFunc", i), (0, n.defineReadOnly)(this, "provider", o)
                }
                send(e, t) {
        ...
        59456: function(e, t, r) {
            ...
            var c = Object.defineProperty,
                ...
                p = (e, t) => {
                    ...
                    if (l)
                        for (var r of l(t)) f.call(t, r) && d(e, r, t[r]);
                    return e
                };
            const m = e => t => {
                    try {
                ...
                g = (e, t) => (r, n, i) => {
                    ...
                    const l = m(o.serialize),
                        h = () => {
                            const e = o.partialize(p({}, n()));
                            let t;
                            const r = l({
                                state: e,
                                version: o.version
                    ...
                    const y = () => {
                        ...
                        return m(c.getItem.bind(c))(o.name).then((e => {
                            ...
                            var t;
                            return g = o.merge(e, null != (t = n()) ? t : d), r(g, !0), h()
                        })).then((() => {
                    ...
                    return i.persist = {
                        setOptions: e => {
                            o = p(p({}, o), e), e.getStorage && (c = e.getStorage())
                        },
                        clearStorage: () => {
            ...
            var y = r(58105);
            const v = new Set;
            const b = "injected.shimDisconnect";
            var w = new WeakMap;
            class E extends i.c {
                constructor(e) {
                    super({ ...e,
                    ...
                    }), (0, i._)(this, "id", void 0), (0, i._)(this, "name", void 0), (0, i._)(this, "ready", "undefined" != typeof window && !!window.ethereum), (0, i.m)(this, w, {
                        writable: !0,
                        value: void 0
                    }), (0, i._)(this, "onAccountsChanged", (e => {
                        0 === e.length ? this.emit("disconnect") : this.emit("change", {
                            account: (0, y.getAddress)(e[0])
                        })
                        ...
                        var e, t;
                        this.emit("disconnect"), null !== (e = this.options) && void 0 !== e && e.shimDisconnect && (null === (t = C().storage) || void 0 === t || t.removeItem(b))
                    }));
                    let t = "Injected";
                ...
                async connect() {
                    try {
                        ...
                        return null !== (e = this.options) && void 0 !== e && e.shimDisconnect && (null === (t = C().storage) || void 0 === t || t.setItem(b, !0)), {
                            account: n,
                            chain: {
                                id: o,
                                unsupported: s
                ...
                async disconnect() {
                    var e, t;
                    const r = await this.getProvider();
                    null !== r && void 0 !== r && r.removeListener && (r.removeListener("accountsChanged", this.onAccountsChanged), r.removeListener("chainChanged", this.onChainChanged), r.removeListener("disconnect", this.onDisconnect), null !== (e = this.options) && void 0 !== e && e.shimDisconnect && (null === (t = C().storage) || void 0 === t || t.removeItem(b)))
                }
                async getAccount() {
                ...
                async getProvider() {
                    return "undefined" !== typeof window && window.ethereum && (0, i.o)(this, w, window.ethereum), (0, i.p)(this, w)
                }
                async getSigner() {
                    const [e, t] = await Promise.all([this.getProvider(), this.getAccount()]);
                    return new s.Q(e).getSigner(t)
                }
                async isAuthorized() {
                    try {
                        var e, t;
                        if (null !== (e = this.options) && void 0 !== e && e.shimDisconnect && (null === (t = C().storage) || void 0 === t || !t.getItem(b))) return !1;
                        const r = await this.getProvider();
                        if (!r) throw new i.b;
            ...
            class A {
                constructor() {
                    ...
                    (0, n._)(this, P), (0, i._)(this, "config", void 0), (0, i._)(this, "storage", void 0), (0, i._)(this, "store", void 0), (0, i.m)(this, _, {
                        writable: !0,
                        value: void 0
                    });
                    const l = null !== (e = c.autoConnect) && void 0 !== e && e,
                        h = null !== (t = c.connectors) && void 0 !== t ? t : [new E],
                        ...
                        d = null !== (s = c.storage) && void 0 !== s ? s : function(e) {
                            let {
                                storage: t,
                                key: r = "wagmi"
                            } = e;
                    ...
                    let m, y = "disconnected";
                    if (l) try {
                        var v, b, w;
                        const e = d.getItem(k, ""),
                            t = null === (v = JSON.parse(e || "{}")) || void 0 === v || null === (b = v.state) || void 0 === b ? void 0 : b.data;
                        y = null !== t && void 0 !== t && t.account ? "reconnecting" : "connecting", m = null === t || void 0 === t || null === (w = t.chain) || void 0 === w ? void 0 : w.id
                    } catch (N) {}
                    const A = "function" === typeof h ? h({
                            chainId: m
                        }) : h,
                    ...
                    this.store = (C = u(g((() => ({
                        ...
                        storage: d,
                        webSocketProvider: p
                    }, this.storage = d, (0, i.o)(this, _, null === d || void 0 === d ? void 0 : d.getItem("wallet")), (0, n.a)(this, P, x).call(this)
                }
                get chains() {
                ...
                async autoConnect() {
                    ...
                    const e = (0, i.p)(this, _) ? [...this.connectors].sort((e => e.id === (0, i.p)(this, _) ? -1 : 1)) : this.connectors;
                    let t = !1;
                    for (const r of e) {
            ...
            function C() {
                return O || (e = "No client defined. Falling back to default client.", v.has(null !== t && void 0 !== t ? t : e) || (console.warn(e), v.add(e)), new A);
                var e, t
            }
        },
        8202: function(e) {
